...
export const BlogPostPage = () => {
  ...
  return (
    <>
      ...
      {/* Header Banner */}
      <section className="page-header text-white pt-32 pb-16 transition-colors duration-300">
      ...
      <article className="py-16 bg-white dark:bg-[#0a0e17] transition-colors duration-300">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          {/* Featured Image */}
          <div className="rounded-3xl overflow-hidden shadow-2xl mb-12 border-2 border-slate-200 dark:border-slate-800">
            <img
              src={post.image}
              alt={title}
              width={1200}
          ...
          {sections && sections.length > 0 && (
            <div className="bg-slate-50 dark:bg-slate-900 rounded-2xl p-6 border border-slate-200 dark:border-slate-800 mb-12">
              ...
              <ul className="space-y-2">
                {sections.map((sec, idx) => (
                  <li key={idx} className="text-xs sm:text-sm text-slate-700 dark:text-slate-300 flex items-center gap-2">
          ...
          {intro && (
            <div className="text-lg sm:text-xl font-medium text-slate-800 dark:text-slate-200 leading-relaxed mb-10 p-6 rounded-2xl bg-amber-500/5 border-s-4 border-amber-500 dark:bg-slate-900/60">
              {intro}
            </div>
          )}
            ...
            <div className="space-y-12 text-slate-700 dark:text-slate-300 text-base sm:text-lg leading-relaxed">
              {sections.map((sec, idx) => (
                <div key={idx} className="space-y-5">
                  <h2 className="text-2xl sm:text-3xl font-black text-slate-900 dark:text-white tracking-tight pt-4">
                    {sec.heading}
                  </h2>
          ...
          {keyTakeaways && keyTakeaways.length > 0 && (
            <div className="mt-14 bg-gradient-to-br from-amber-500/10 via-yellow-500/5 to-transparent dark:from-slate-850 dark:to-slate-900 rounded-3xl p-8 border-2 border-amber-500/30 shadow-lg">
          ...
          {conclusionText && (
            <div className="mt-14 bg-slate-900 text-white dark:bg-slate-850 rounded-3xl p-8 sm:p-10 border-2 border-amber-500/40 shadow-2xl relative overflow-hidden">
          ...
          {/* Author Card */}
          <div className="bg-slate-50 dark:bg-slate-900 rounded-3xl p-8 border border-slate-200 dark:border-slate-800 my-12 flex flex-col sm:flex-row items-center sm:items-start gap-6 text-center sm:text-start group">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {relatedPosts.map((rel) => (
                <Link
                  key={rel.id}
                  to={`/blog/${rel.id}`}
                  className="group bg-slate-50 dark:bg-slate-900 rounded-2xl overflow-hidden border border-slate-200 dark:border-slate-800 hover:-translate-y-1 transition-all duration-300 flex flex-col justify-between focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-500"
                >
